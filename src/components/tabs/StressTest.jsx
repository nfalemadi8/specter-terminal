...
const SCENARIOS = [
  ...
  },
  {
    ...
    desc: 'S&P 500 -34%, pandemic shutdown, liquidity crisis',
    marketShock: -34,
  ...
  },
  {
    ...
    desc: 'Nasdaq -78%, tech bubble burst',
    marketShock: -45,
  ...
  {
    id: 'ratehike',
    name: 'Aggressive Rate Hike (+300bp)',
    desc: 'Fed raises rates 300bp, bond selloff, growth rotation',
    marketShock: -18,
  ...
  },
  {
    id: 'stagflation',
    name: 'Stagflation',
    desc: 'High inflation + recession, 1970s-style scenario',
    marketShock: -25,
  ...
  },
  {
    ...
    desc: 'Regulatory crackdown + AI bubble concerns',
    marketShock: -12,
    sectorShocks: { Technology: -35, 'Communication Services': -28, 'Consumer Discretionary': -10, Financials: -5, Healthcare: 2, Energy: 0, 'Consumer Staples': 2 },
  },
];
